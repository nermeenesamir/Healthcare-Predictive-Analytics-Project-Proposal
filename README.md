...
Project Objectives:
•
Analyze healthcare data to identify key risk factors associated with stroke
•
Perform exploratory data analysis to understand medical and lifestyle patterns
•
Build and evaluate machine learning models for stroke risk prediction
•
Deliver an accurate and interpretable healthcare prediction system
